						...
						<div class="col-md-12">
							...
							<div class="form-group">
								<div class="row">
									<div class="col-md-6">
										...
										<input class="form-control" name="mobile" id="exampleMobile" type="text"  placeholder="Enter Mobile Number">
									</div>
									<div class="col-md-6">
										<label for="examplephone">Home Phone</label>
										<input class="form-control" name="phone" id="examplephone" type="text"  placeholder="Enter Phone Number">
									</div>
								</div>
							</div>
							<div class="form-group">
								<div class="row">
									<div class="col-md-8">
										...
										<input class="form-control" name="address" id="exampleAddress" type="text"  placeholder="Enter Address">
									</div>
									<div class="col-md-4">
										<label for="examplePincode">Pincode</label>
										<input class="form-control" name="pincode" id="examplePincode" type="text"  placeholder="Enter Pincode">
									</div>
								</div>
							</div>
							<div class="form-group">
								<div class="row">
									<div class="col-md-4">
										...
										<input class="form-control" name="city" id="exampleCity" type="text"  placeholder="Enter City">
									</div>
									<div class="col-md-4">
										<label for="exampleDOB">Date Of Birth</label>
										<input class="form-control" name="dob" id="exampleDOB" type="date">
									</div>
									<div class="col-md-4">
							...
							<div class="form-group">
								<div class="row">
									...
									<div class="col-md-3">
										<button type="submit" class="btn btn-primary btn-xm btn-fill btn-block">Add Employee</button>
									</div>
								</div>
							</div>
						</div>
...
<script>
	$("#add_profile").validate({
		...
		submitHandler: function(form) {
			...
			$.ajax({
				type:"POST",
				url: "mysql_query.php?action=add_employee",
				data: $("#add_profile").serialize(),
				beforeSend: function(){
				},
