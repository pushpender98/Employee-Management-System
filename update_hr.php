...
$sql="select * from ems_hr_profile where employee_id='$id'";
...
<div class="content">
	<div class="container-fluid">
		<div class="card">
			...
			<div class="content">
				<div class="row">					
					<form method="post" id="update_hr_profile">	
						<div class="col-md-12">
							...
							<div class="form-group">
								<div class="row">
									<div class="col-md-6">
										...
										<input class="form-control" name="mobile" id="exampleMobile" type="text"  placeholder="Enter Mobile Number" value="<?php echo $row['mobile']; ?>">
									</div>
									<div class="col-md-6">
										<label for="examplephone">Home Phone</label>
										<input class="form-control" name="phone" id="examplephone" type="text"  placeholder="Enter Phone Number" value="<?php echo $row['phone']; ?>">
									</div>
								</div>
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								<div class="row">
									...
									<div class="col-md-4">
										...
										<input class="form-control" name="dob" id="exampleDOB" type="date" value="<?php echo $row['dob']; ?>">
									</div>
									<div class="col-md-4">
										<label for="password">Password </label>
										<input class="form-control" name="password" id="password" type="password" value="<?php echo $row['password']; ?>">
									</div>
								</div>
							</div>
...
<script>
	$("#update_hr_profile").validate({
		...
		submitHandler: function(form) {
			...
			$.ajax({
				type:"POST",
				url: "mysql_query.php?action=update_hr",
				data: $("#update_hr_profile").serialize(),
				beforeSend: function(){
				},
